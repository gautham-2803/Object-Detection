...
class YoloV5ObjectDetector {
    ...
    private val outputSize = intArrayOf(1, 25200, 13)
    ...
    val modelFile = "run_23_may.tflite"
    ...
    fun initialModel(activity: Context?) {
        ...
        try {
            ...
            var tensorShape = tflite!!.getOutputTensor(0).shape()

            Log.i("TensorShape","tensor count: $tensorShape.")
    ...
    fun detect(bitmap: Bitmap?): ArrayList<Recognition?> {
        ...
        Log.i("Debu", "Recognition: $nmsRecognitions")
        Log.i("Debu_length", "Recognition: ${nmsRecognitions.size}")

        val nmsFilterBoxDuplicationRecognitions = nmsAllClass(nmsRecognitions)
        Log.i("Duplicate", "Duplicate Recognition: $nmsFilterBoxDuplicationRecognitions")
        Log.i("Duplicate_length", "Duplicate Recognition: ${nmsFilterBoxDuplicationRecognitions.size}")
